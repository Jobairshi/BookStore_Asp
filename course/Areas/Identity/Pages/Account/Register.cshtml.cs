...
namespace course.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever]
            public IEnumerable<SelectListItem> ComphanyList { get; set; }
        }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel() // for drop doawing item
            {
                ...
                ComphanyList = _unitOfWork.Comphany.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                }),
